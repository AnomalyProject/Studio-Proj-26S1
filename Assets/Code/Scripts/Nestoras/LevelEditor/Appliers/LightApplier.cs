...
public class LightApplier : IComponentApplier
{
    ...
    private Dictionary<string, Action<Light, FieldSnapshot>> supportedFields { get; } = new Dictionary<string, Action<Light, FieldSnapshot>>()
    {
        ...
        { "m_Shadows", (l, field) => l.shadows = (LightShadows)field.GetAs<int>() },
        { "m_Shadows.m_Type", (l, field) => l.shadows = (LightShadows)field.GetAs<int>() },
        { "m_Shadows.m_Resolution", (l, field) => l.shadowResolution = (LightShadowResolution)field.GetAs<int>() },
        { "m_Shadows.m_CustomResolution", (l, field) => l.shadowCustomResolution = field.GetAs<int>() },
        { "m_Shadows.m_Strength", (l, field) => l.shadowStrength = field.GetAs<float>() },
        { "m_Shadows.m_Bias", (l, field) => l.shadowBias = field.GetAs<float>() },
        { "m_Shadows.m_NormalBias", (l, field) => l.shadowNormalBias = field.GetAs<float>() },
        { "m_Shadows.m_NearPlane", (l, field) => l.shadowNearPlane = field.GetAs<float>() },
        { "m_Shadows.m_UseCullingMatrixOverride", (l, field) => l.useShadowMatrixOverride = field.GetAs<bool>() },
